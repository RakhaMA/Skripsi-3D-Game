...
public class OcclusionCullingComparison : MonoBehaviour
{
    public LayerMask layerToCheck; // Layers to identify relevant GameObjects
    private List<GameObject> objectsToCheck = new List<GameObject>();
    private int occludedWithCulling;
    private int occludedWithoutCulling;
    ...
    void Update()
    {
        ...
        occludedWithCulling = CountOccludedObjects();

        // Temporarily disable occlusion culling
        Camera.main.useOcclusionCulling = false;
        occludedWithoutCulling = CountOccludedObjects();
        Camera.main.useOcclusionCulling = true;

        Debug.Log("Number of objects occluded with occlusion culling: " + occludedWithCulling);
        Debug.Log("Number of objects occluded without occlusion culling: " + occludedWithoutCulling);
    }

    int CountOccludedObjects()
    {
        int occludedCount = 0;
